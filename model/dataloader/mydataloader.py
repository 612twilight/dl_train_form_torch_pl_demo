...
from model.component.components import transformers_bert_batch
...
class BatchReader(object):
    def __init__(self, data):
        ...
        self.token_ids = transformers_bert_batch(transposed_data[0])
...
batch_data_loader = partial(DataLoader, collate_fn=collate_fn, pin_memory=True)
